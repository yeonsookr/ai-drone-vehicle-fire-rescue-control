...
// Domain: drones are the camera source, vehicles relay drone video to server.
// n drones → 1 vehicle (gateway) → 1 server
...
const MOCK_STREAMS: VideoStream[] = [
  ...
  { id: 3, mission_id: null, device_type: 'drone', device_id: 'DRONE-003', stream_url: '', status: 'inactive', started_at: new Date().toISOString(), ended_at: null },
  { id: 4, mission_id: null, device_type: 'drone', device_id: 'DRONE-004', stream_url: '', status: 'streaming', started_at: new Date().toISOString(), ended_at: null },
]
